-- Multi-user RLS policies for operacoes, despesas and lancamentos.
-- Safe to re-run: existing policies are dropped before creation.
...
CREATE POLICY operacoes_select_own
ON public.operacoes
FOR SELECT
TO authenticated
...
-- ============================================================================
-- 3) LANCAMENTOS
-- Ownership is validated through the related operacao (operacoes.id).
-- ============================================================================
...
CREATE POLICY lancamentos_select_by_operacao_owner
