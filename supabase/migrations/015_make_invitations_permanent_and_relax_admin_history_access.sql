-- 015_make_invitations_permanent_and_relax_admin_history_access.sql
-- 1) Invitation acceptance no longer expires by date.
-- 2) Admin keeps historical access to gestor data even if vínculo is inativo.
